...
$(document).ready(function () {
	...
	//Центрування трикутників перщої секції
	function carCorner() {
		var winWidth = $(window).width()
		var corWidth = winWidth / 2
		var corTop = $('.carousel-corner-top')
		var corBot = $('.carousel-corner-bot')
	...
	mCar.on("changed.owl.carousel", function () {
		setTimeout(function () {
			var centerImg = $(".main-carousel").find(".center").find(".main-carousel-item"),
